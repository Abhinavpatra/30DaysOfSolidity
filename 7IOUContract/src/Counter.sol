...
contract IOUContract {
    ...
    mapping (address => uint) friendBalances;
    ...
    function payFromWallet(address _creditor, uint256 _amount) public {
        require(_creditor != address(0), "Invalid address");
        require(isAFriend[_creditor], "Creditor not registered");
        require(_amount > 0, "Amount must be greater than 0");
        require(debts[msg.sender][_creditor] <= _amount, "");
